/*
 *
 * Parametresi ile aldığı int türden bir sayının Collatz serisine ilişkin sayılarını ekrana basan printCollatz metodunu
 * yazınız.
 * Açıklamalar:
 *     Collatz conjecture: n bir pozitif tamsayı olmak üzere her yeni n değeri için aşağıdaki kurallar uygulanacaktır:
 *       - n, 1 değerine eşit ise işlemler sonlandırılacaktır. - n çift ise yeni n değeri olarak n / 2, n tek ise yeni n
 *       değeri olarak 3 * n + 1 alınacaktır.
 * Örnek:
 ...
 *
 *       Ekrana basma formatını dilediğiniz gibi yapabilirsiniz.
 *
 * */
